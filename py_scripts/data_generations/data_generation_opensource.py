...
model_fullnames = {  'gptj_6b': 'gpt-j-6b', # https://huggingface.co/EleutherAI/gpt-j-6b/tree/main
                     ...
                     'falcon3_7b': 'falcon3-7b-instruct', # https://huggingface.co/tiiuae/falcon-3-10b/tree/main
                     'gemma3_12b': 'gemma3-12b', # https://huggingface.co/google/gemma-3-12b/tree/main
                     'qwen3-8b': 'Qwen3-8B', # https://huggingface.co/Qwen/Qwen3-8B/tree/main
                     }
...
def load_original_data(dataset_name):
    assert dataset_name in ["xsum",'squad','writing', "reddit", "wmt16_german"], "The dataset name must be enclosed within ['xsum','squad','writing', 'reddit']."
...
if __name__=="__main__":
    ...
    parser.add_argument('--output_file', type=str, default="datasets/human_llm_data_for_experiment/llama3-8b")
