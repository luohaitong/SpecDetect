...
def experiment(args):
    ...
    criterion_fns = {
                     'stft_power': based_scoring_baselines.get_specdetect_stftpower,
                     'flux': based_scoring_baselines.get_specdetect_flux,
                     'sum': based_scoring_baselines.get_specdetect_sum,
                     'cheng':based_scoring_baselines.get_specdetect_cheng,}
